                ...
                {filteredList.map(item => (
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <div
                                className={`font-bold truncate ${selectedId === item.id ? 'text-lime-700' : 'text-base-content'}`}>{item.name}</div>
                            <div
                                className={`text-xs truncate ${selectedId === item.id ? 'text-lime-600 font-medium' : 'text-gray-500'}`}>{item.msg}</div>
                        </div>
